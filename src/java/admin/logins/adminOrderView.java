 ...
 * @author DAGIM
 */
@WebServlet(name = "adminOrderView", urlPatterns = {"/admin/orders"})
public class adminOrderView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet adminOrderView</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet adminOrderView at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("loggedIn") == null || (boolean) session.getAttribute("isAdmin") == false) {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/admin/adminOrdersView.jsp");
